...
\tadOperacion{indiceDeRareza}{pgo, pokemon/q}{Nat}{cuentaTotalPokemones(pgo) > \hspace{1mm}0}
...
\tadAxioma{cuentaTipoPokemones(agJugador($pgo$, $j$), $q$)}{cantPoke($j$, $q$) + cuentaTipoPokemones($pgo$, $q$)}
