...
\tadExporta {pGo, generadores, observadores, moverJugador, conectarJug, desconectarJug, indDeRareza, nombres}

\tadUsa {Bool, Nat, Jugador, Conjunto(Jugador), Pokemon, Coordenada, Mapa, PokeNodo, Conjunto(PokeNodo)}

\tadAlinearFunciones{cuentaTotalPokemones}{pGo/pgo,jugador/j,coordenada/c}{Nat}{}
...
% Mapa (pgo)
$ $\newline
\tadAxioma{mapa(crearPGO($map$))}{$mapa$}
