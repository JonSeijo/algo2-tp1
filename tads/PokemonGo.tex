...
\tadOperacion{moverJugador}{pGo/pgo,jugador/j,coordenada/c}{pGo}{sanciones($j$) $\leq$ 4 $\land$ existeCoor(mapa($pgo$))}
\tadOperacion{conectarJug}{pGo/pgo, jugador/j,coordenada/c}{pGo}{sanciones($j$) $\leq$ 4 $\land$ existeCoor(mapa($pgo$)) $\land$ $\neg$conectado(j)}
...
\tadOperacion{indeDeRareza}{pGo/pgo, pokemon/q}{Nat}{cuentaTotalPokemones($pgo$) > \hspace{1mm}0}
